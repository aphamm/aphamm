      ...
      >
        <VStack position="fixed" align="flex-start" spacing={10}>
          <VStack align="flex-start">
            ...
            <Navigation link="/produced">Produced</Navigation>
            <Navigation link="/consumed">Consumed</Navigation>
          </VStack>
          <VStack align="flex-start">
            <Text fontWeight="bold" fontSize="smaller">
              FIND ME ON
            </Text>
            <Navigation link="https://github.com/aphamm" isExternal>
              GitHub
            </Navigation>
            <Navigation link="https://soundcloud.com/austin-pham-40930406" isExternal>
              SoundCloud
            </Navigation>
          </VStack>
        </VStack>
                ...
                <MenuList>
                  ...
                  <MenuGroup title="FIND ME ON">
                    <VStack align="flex-start" px={4} spacing={3} mb={2}>
                      ...
                      <Navigation
                        link="https://soundcloud.com/austin-pham-40930406"
                        isExternal
                      >
                        SoundCloud
                      </Navigation>
